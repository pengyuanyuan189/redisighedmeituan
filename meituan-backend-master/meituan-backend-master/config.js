module.exports = {
    ...
    notifyUrl: 'http://192.168.43.8',      //支付异步通知地址
    ...
    tencentkey: 'TYCBZ-KD2C2-NCMUV-C5QSY-WXWG6-ZXBMX',        //腾讯位置secreKey
    tencentkey2: 'TYCBZ-KD2C2-NCMUV-C5QSY-WXWG6-ZXBMX',        //腾讯位置服务secreKey
